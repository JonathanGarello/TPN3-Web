...
<body background="../img/abstract-yellow.jpg" class="container-fluid">
    ...
    <form class="container-fluid btn btn-primary" action="ejercicio1.php" method="post" enctype="multipart/form-data">
...
<div class=" container d-flex mt-5 pb-5 flex-column justify-content-center align-items-center">
    ...
    for ($i = 2; $i < sizeof($ficheros1); $i++) {
        echo "<img src='./imagenes/" . $ficheros1[$i]. "' >" . "<br>" . "<br>";
        echo "<p> " . $ficheros1[$i]."</p>" . "<br>" . "<br>";
    ...
    function copiarArchivo($destination){
        ...
        copiarArchivo("./imagenes/" . $_FILES["archivo"]["name"]);
    ?>
    </div>
