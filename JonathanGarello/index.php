...
<body background="img/abstract-yellow.jpg" class="container-fluid">
    ...
    <main class="container mt-5 pb-5 justify-content-center align-items-center">
        <iframe height="800" class="container mt-5 btn-primary" src="https://miel.unlam.edu.ar/data/contenido/2628/PHP_-Trabajo-pra--ctico-N--4---2021-1er-cuatri.pdf" frameborder="0"></iframe>
    </main>
</body>
</html>